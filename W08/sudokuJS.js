    ...
    $.fn.sudokuJS = function (opts) {
		...
		*/
        ...
        var renderBoard = function () {
            ...
            var HTMLSnippet = [
                // '<div class="linkButton" onclick="window.location=`https://mczak.com/code/sudoku/`">Sudoku HTML</div>',
                // '<a class="linkButton" href="https://mczak.com/code/sudoku/" target="_blank">Sudoku HTML</a>',
            ].join('');
            ...
            if (val > 0) {
                ...
                for (var i = 0; i < houses.length; i++) {
                    if (indexInHouse(val, houses[i][temp[i]])) {
                        ...
                        $(
                            '#input-' +
                                alreadyExistingCellInHouseWithDigit +
                                ', #input-' +
                                id
